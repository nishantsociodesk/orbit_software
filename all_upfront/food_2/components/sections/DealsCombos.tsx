        ...
        <section className="py-16 md:py-24 bg-muted/50">
            <div className="container mx-auto px-4 md:px-6 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {combos.map((combo) => (
                        <Card key={combo.id} className="overflow-hidden border-border shadow-lg bg-card flex flex-col sm:flex-row items-center">
                            ...
                            <CardContent className="p-8 text-left space-y-4 sm:w-1/2">
                                ...
                                <h3 className="text-2xl font-bold text-card-foreground leading-tight uppercase">{combo.name}</h3>
