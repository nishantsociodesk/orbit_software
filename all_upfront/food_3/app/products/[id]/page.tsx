...
export default function ProductDetailPage() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-2xl font-black uppercase tracking-tighter text-foreground">Product not found</h1>
    ...
    const formatIngredients = (ingredients: string[]) => {
        return ingredients.map((item, index) => {
            ...
            return (
                <li key={index} className="text-muted-foreground mb-1 text-sm">
                    {hasAllergen ? <strong className="text-foreground">{item}</strong> : item}
                </li>
            )
        })
    }
            ...
            <div className="container mx-auto px-4 md:px-6 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
                    ...
                    <div className="space-y-6">
                        <div className="aspect-square relative rounded-none overflow-hidden bg-card border border-border shadow-[20px_20px_0px_0px_rgba(20,20,20,1)]">
                            <Image
                            ...
                            />
                            {product.badge && (
                                <div className="absolute top-6 left-6 bg-foreground text-background text-[10px] font-black uppercase tracking-[0.3em] px-4 py-2 shadow-xl">
                                    {product.badge}
                                </div>
                            )}
                        </div>
                    ...
                    <div className="flex flex-col gap-8">
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-6">
                                <div className="flex items-center gap-1.5 bg-card text-foreground border border-border px-3 py-1 text-xs font-black">
                    ...
                    <Tabs defaultValue="description" className="w-full">
                        ...
                        <TabsContent value="description" className="mt-0 outline-none">
                            <div className="max-w-3xl">
                                <p className="text-foreground/80 leading-loose text-lg font-medium italic mb-6">"Something special in every bite."</p>
                        ...
                        <TabsContent value="storage" className="mt-0 outline-none">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-4 bg-card text-card-foreground p-10 border border-border">
                                    <h3 className="text-xs font-black uppercase tracking-[0.3em] text-primary">Storage Instructions</h3>
                                    <p className="text-muted-foreground leading-relaxed font-medium">{product.storage.instructions}</p>
                                </div>
                                <div className="space-y-4 border border-border p-10">
                                    <h3 className="text-xs font-black text-muted-foreground uppercase tracking-[0.3em]">Freshness Guarantee</h3>
                                    <p className="text-foreground leading-relaxed font-black text-4xl tracking-tighter uppercase">{product.storage.bestBefore}</p>
                                    <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">{product.storage.disclaimer}</p>
                                </div>
                            </div>
                        </TabsContent>
                    </Tabs>
                ...
                {relatedProducts.length > 0 && (
                    <div className="border-t border-zinc-100 pt-20">
                        <div className="flex items-center justify-between mb-12">
                            <div>
                                <h2 className="text-3xl font-black tracking-tighter text-foreground uppercase">You may also like</h2>
