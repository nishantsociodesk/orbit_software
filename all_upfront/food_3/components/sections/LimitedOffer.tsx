    ...
    return (
        <section className="py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="relative overflow-hidden rounded-3xl bg-card px-8 py-12 md:px-16 md:py-20 text-center text-foreground">
                    <div className="relative z-10 flex flex-col items-center space-y-8">
                        <div className="space-y-4">
                            <h2 className="text-3xl font-extrabold tracking-tighter sm:text-5xl uppercase md:text-6xl text-foreground">
                                Limited-Time Offer
                            </h2>
                        ...
                        <div className="flex gap-4 md:gap-8">
                            {[{ l: "Hrs", v: "02" }, { l: "Min", v: "45" }, { l: "Sec", v: "30" }].map((item) => (
                                <div key={item.l} className="flex flex-col items-center space-y-2">
                                    ...
                                    <span className="text-xs md:text-sm uppercase tracking-widest text-muted-foreground font-bold">{item.l}</span>
                                </div>
                            ))}
                        </div>

                        <Button size="lg" className="bg-foreground text-background hover:bg-muted-foreground px-12 py-8 text-xl font-bold uppercase tracking-widest h-auto">
                            Shop Now
                        </Button>
                    </div>
