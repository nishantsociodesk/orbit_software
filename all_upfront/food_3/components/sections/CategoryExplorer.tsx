            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-foreground uppercase">Explore Categories</h2>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-6">
                    {categories.map((category) => (
                        <Link key={category.name} href={`/categories/${category.slug}`}>
                            <Card className="group relative overflow-hidden rounded-xl border-none bg-card shadow-md transition-all hover:shadow-xl hover:-translate-y-1">
