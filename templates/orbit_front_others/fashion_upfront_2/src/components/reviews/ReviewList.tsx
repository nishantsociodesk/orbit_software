        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
                ...
                <div className="mt-8 border-t pt-6" style={{ borderColor: 'var(--card-border)' }}>
                    <h3 className="font-bold mb-2" style={{ color: 'var(--text)' }}>Review this product</h3>
                    <p className="text-sm mb-4" style={{ color: 'var(--text-muted)' }}>Share your thoughts with other customers</p>
                    <button
                        onClick={() => setShowReviewForm(true)}
                        className="w-full py-2 px-4 border rounded shadow-sm hover:bg-gray-50 transition-colors font-medium"
                    >
            ...
            <div className="lg:col-span-2">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="font-bold text-lg" style={{ color: 'var(--text)' }}>Top reviews from India</h3>
                    <div>
                        <select
                            value={sortBy}
                            onChange={(e) => setSortBy(e.target.value as 'recent' | 'highest' | 'lowest' | 'helpful')}
                            className="p-2 border rounded-md text-sm cursor-pointer focus:outline-none focus:ring-1 focus:ring-blue-500"
